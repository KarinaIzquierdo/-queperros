<footer class="mq-login-bottom" aria-label="Pie de página">
    @php
        ...
        if ($bizPhone === '') $bizPhone = '3102392128 - 3246894960';
        ...
        <div class="mq-login-footer-col">
            ...
            <ul class="mq-footer-social example-2" aria-label="Redes sociales">
                <li class="icon-content">
                    <a data-social="whatsapp" aria-label="WhatsApp" href="https://wa.me/573102392128" target="_blank" rel="noopener noreferrer">
